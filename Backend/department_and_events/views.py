...
# from .models import Activity, ReportStatus, Brochure
# from .serializers import Department, Department_head, User_department_map, EventReport
# from .serializers import DepartmentSerializer, Department_headSerializer, ActivitySerializer, user_department_mapSerializer, EventSerializer, EventReportSerializer, ReportStatusSerializer,BrochureSerializer
