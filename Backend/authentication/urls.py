...
from .views import csv_user_view, register, login_with_email, user_deactivate, user_delete, user_list, user_logout, user_update, verify_otp, multiple_user_registration,user_token_refresh
